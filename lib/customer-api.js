...
import { apiGetAuth, apiPostAuth, apiPatchAuth, apiDeleteAuth } from "./auth-api";
...
export async function getMe() {
  return apiGetAuth(`${V1}/users/me`);
}

/** PATCH /users/me/personal-details */
export async function updatePersonalDetails(payload) {
  return apiPatchAuth(`${V1}/users/me/personal-details`, payload);
}
