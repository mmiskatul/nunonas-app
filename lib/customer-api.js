...
/** POST /customer/events/:id/bookings */
export async function bookEventTickets(eventId, payload) {
  return apiPostAuth(`${C}/events/${eventId}/bookings`, payload);
}
...
/** GET /customer/map/events */
export async function getMapEvents(limit = 50) {
  return apiGetAuth(`${C}/map/events${buildQuery({ limit })}`);
}
