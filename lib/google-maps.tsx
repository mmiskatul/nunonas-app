...
export function buildStaticMapUrl({
  ...
  if (markerLabel) {
    markerParts.push(`label:${markerLabel.slice(0, 1).toUpperCase()}`);
  }
...
export function buildDirectionsUrl(origin: GeoCoordinates | null, destination: GeoCoordinates | null): string | null {
