...
export default function EventMapWeb() {
  ...
  const mappedEvents = useMemo(() => events.filter((event) => event.latitude != null && event.longitude != null), [events]);
